...
@section('container')
    ...
    @if ($posts->count())
        <div class="card mb-3">
            <img src="https://www.dartmoorzoo.org.uk/wp-content/uploads/2021/01/Tiger-1.jpg" class="card-img-top" alt="{{ $posts[0]->category->name }}">
            ...
            @foreach ($posts->skip(1) as $post)
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        <a href="/categories/{{ $posts[0]->category->slug }}" class="text-decoration-none text-white">{{ $posts[0]->category->name }}
                        </a>
                        </div>

                        <img src="https://images.unsplash.com/photo-1442544213729-6a15f1611937?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1632&q=80" class="card-img-top" alt="{{ $post->category->name }}">
                        <div class="card-body">
                        <h5 class="card-title">
